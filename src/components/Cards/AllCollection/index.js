...
const AllCollection = () => {
    ...
    return (<div className="relative blur-glass overflow-visible my-8 h-96 mx-8 p-2">
        ...
        <div className="flex flex-col items-center relative bg-white w-full h-68 rounded-b-lg">
            ...
            <div className="text-lg w-full truncate text-center px-2 text-main-default font-bold pt-20"> Harmoonies</div>
            ...
            <PrimaryBlue onClick={() => navigate("harmoonies")} className="mx-auto mt-4">Explore Collection</PrimaryBlue>
