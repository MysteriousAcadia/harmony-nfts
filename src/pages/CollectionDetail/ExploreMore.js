...
const NFTCard = () => {
    return (<>
        <div className="glass-2 w-full p-4 m-4 tex-sm">
            ...
            <div className="flex justify-between items-center mt-8 font-bold"><span>Harmoonie #234</span><span>500 ONE</span></div>
        </div>
    </>);
}
                    ...
                    <>
                        <div >
                            <Disclosure.Button className="p-6 text-left w-full flex justify-between items-center ">
                                <span className="font-bold flex-grow w-full">More from the Collection</span>
                        ...
                        <Disclosure.Panel as="div" className="mt-2 p-6 border-t border-gray-400 pr-12">
                            <p className="flex items-center justify-between">
                                ...
                                <div className="flex-grow text-center text-lg w-2/3">View All -></div>
                            </p>
                        </Disclosure.Panel>
                    </>
                )}
